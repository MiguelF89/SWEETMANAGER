...
use App\Http\Controllers\API\ClienteApiController; // Atualizado para Cliente
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // ── Resources ────────────────────────────────────────────
    Route::apiResource('clientes', ClienteApiController::class); // Atualizado para clientes

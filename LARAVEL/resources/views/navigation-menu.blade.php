            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        ...
                        <x-nav-link href="{{ route('encomendas.index') }}" :active="request()->routeIs('encomendas.*')">
                            Encomendas
                        </x-nav-link>
            ...
            @guest
                <div class="hidden sm:flex sm:items-center sm:ms-6 space-x-3">
                    ...
                    @if (Route::has('register'))
                        <a
                            href="{{ route('register') }}"
                            class="inline-flex items-center px-3 py-2 bg-indigo-600 text-white text-sm leading-4 font-medium rounded-md hover:bg-indigo-700"
                        >
                            Cadastrar
                        </a>
                    @endif
        ...
        @auth
            ...
            <div class="pt-2 pb-3 space-y-1">
                ...
                <x-responsive-nav-link
                    ...
                    :active="request()->routeIs('encomendas.*')"
                >
                    Encomendas
                </x-responsive-nav-link>

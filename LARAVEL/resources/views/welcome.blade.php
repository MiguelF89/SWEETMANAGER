                ...
                <div class="max-w-4xl mx-auto px-6 lg:px-8 text-center">
                    ...
                    @auth
                        <div class="grid grid-cols-1 md:grid-cols-1 gap-8">
                            <div class="mx-auto max-w-xl bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6 transition duration-300 ease-in-out transform hover:scale-[1.02] border-t-4 border-orange-500">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-gray-600 dark:text-gray-400 mb-4">
                                        Acesse o painel de controle agora mesmo.
                                    </p>
                                    <a href="{{ url('/dashboard' ) }}" 
